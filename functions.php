...
if ( ! function_exists( 'themeplace_setup' ) ) :
	...
	function themeplace_setup() {
		 ...
		 * to change 'themeplace' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'themeplace', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'primary' => esc_html__( 'Primary', 'themeplace' ),
		) );
...
function themeplace_widgets_init() {
  ...
  register_sidebar( array(
    'name'          => esc_html__( 'Sidebar', 'themeplace' ),
    'id'            => 'sidebar',
    'description'   => esc_html__( 'Add widgets here.', 'themeplace' ),
  ...
  register_sidebar( array(
    'name'          => esc_html__( 'EDD Archive Sidebar', 'themeplace' ),
  ...
  register_sidebar( array(
    'name'          => esc_html__( 'Footer', 'themeplace' ),
    'id'            => 'footer',
    'description'   => esc_html__( 'Add widgets here.', 'themeplace' ),
...
function themeplace_register_download_metafields() {
  ...
  $download->add_field( array(
    'name'       => esc_html__( 'Product Type', 'themeplace' ),
    'desc'       => esc_html__( 'Select product type', 'themeplace' ),
    'id'         => 'type',
    'type'       => 'select',
    'default'    => 'theme',
    'options'    => array(
      'theme'    => __( 'Theme and Template', 'themeplace' ),
      'psd'      => __( 'PSD Template', 'themeplace' ),
      'plugin'   => __( 'Plugin', 'themeplace' ),
      'video'    => __( 'Video', 'themeplace' ),
      'audio'    => __( 'Audio', 'themeplace' ),
      'graphics' => __( 'Graphics', 'themeplace' ),
      'photo'    => __( 'Photo', 'themeplace' )
    ),
  ));

  $download->add_field( array(
    'name' => esc_html__( 'Video', 'themeplace' ),
    'desc' => esc_html__( 'Upload a video mp4 preview for video product', 'themeplace' ),
    'id'   => 'video',
    'type' => 'file',
    'preview_size' => 'large',
    'attributes' => array(
  ...
  $download->add_field( array(
    'name' => esc_html__( 'Audio', 'themeplace' ),
    'desc' => esc_html__( 'Upload an audio sample mp3 for audio product', 'themeplace' ),
    'id'   => 'audio',
    'type' => 'file',
    'preview_size' => 'large',
    'attributes' => array(
  ...
  $download->add_field( array(
    'name' => esc_html__( 'Preview Images', 'themeplace' ),
    'desc' => esc_html__( 'Upload demo images of PSD template', 'themeplace' ),
    'id'   => 'psd',
    'type' => 'file_list',
    'text' => array(
  ...
  $download->add_field( array(
    'name'       => esc_html__( 'Product Thumbnail', 'themeplace' ),
    'desc'       => esc_html__( 'Product thumbnail to show in different sections ( 80x80 )', 'themeplace' ),
  ...
  $download->add_field( array(
    'name'       => esc_html__( 'Preview Url', 'themeplace' ),
    'desc'       => esc_html__( 'Preview Url to show in single download page', 'themeplace' ),
    'id'         => 'preview_url',
    'type'       => 'text',
    'attributes' => array(
      'data-conditional-id'     => 'type',
  ...
  $download->add_field( array(
    'name'       => esc_html__( 'Affiliate URL', 'themeplace' ),
    'desc'       => esc_html__( 'When you set affiliate link. add to cart or buy button will be disappear', 'themeplace' ),
    'id'         => 'affiliate_url',
    'type'       => 'text',
  ));

  $download->add_field( array(
    'name'       => esc_html__( 'Sub Heading', 'themeplace' ),
    'desc'       => esc_html__( 'Sub Heading for the item', 'themeplace' ),
    'id'         => 'subheading',
    'type'       => 'text',
  ) );

  $download->add_field( array(
    'name'       => esc_html__( 'Download Tag', 'themeplace' ),
    'id'         => 'download_tag',
    'type'       => 'radio',
    'options'    => array(
      'Sale' => 'Sale',
  ...
  $download->add_field( array(
    'name'       => esc_html__( 'Version', 'themeplace' ),
    'desc'       => esc_html__( 'Version of the item', 'themeplace' ),
    'id'         => 'version',
    'type'       => 'text',
  ) );

  $download->add_field( array(
    'name' => esc_html__( 'File Size', 'themeplace' ),
    'desc' => esc_html__( 'Size of source. E.g. 150KB, 50.5KB, 12.5MB, 5MB, 1GB, 2.1GB.', 'themeplace' ),
    'id'   => 'file_size',
    'type' => 'text',
  ) );

  $download->add_field( array(
    'name'       => esc_html__( 'Documentation', 'themeplace' ),
    'id'         => 'documentation',
    'type'       => 'radio',
    'options'    => array(
      'Yes' => 'Yes',
  ...
  $features_group = $download->add_field( array(
    ...
    'type'        => 'group',
    'description' => esc_html__( 'Generates reusable custom features', 'themeplace' ),
    'options'     => array(
      'group_title'       => esc_html__( 'Features {#}', 'themeplace' ),
      'add_button'        => esc_html__( 'Add Another Features', 'themeplace' ),
      'remove_button'     => esc_html__( 'Remove Features', 'themeplace' ),
      'sortable'          => true,
      'remove_confirm' => esc_html__( 'Are you sure you want to remove?', 'themeplace' )
    ),
  ) );

  $download->add_group_field( $features_group, array(
    'name' => esc_html__( 'Feature Name', 'themeplace' ),
    'id'   => 'themeplace_feature_name',
    'type' => 'text'
  ) );

  $download->add_group_field( $features_group, array(
    'name' => esc_html__( 'Feature List', 'themeplace' ),
  ...
  $support = $download->add_field( array(
      'id'          => 'support',
      'type'        => 'group',
      'description' => esc_html__( 'Generates reusable form entries', 'themeplace' ),
      'options'     => array(
      'group_title'   => esc_html__( 'Support {#}', 'themeplace' ),
      'add_button'    => esc_html__( 'Add Another Support', 'themeplace' ),
      'remove_button' => esc_html__( 'Remove Support', 'themeplace' ),
      'sortable'      => true,
    ),
  ) );

  $download->add_group_field( $support, array(
    'name' => esc_html__( 'Support Title', 'themeplace' ),
    'id'   => 'themeplace_support_title',
    'type' => 'text'
  ) );

  $download->add_group_field( $support, array(
    'name'       => esc_html__( 'Support Include', 'themeplace' ),
    'id'         => 'support_include',
    'type'       => 'radio',
    'options'    => array(
      'Yes' => 'Yes',
  ...
  $download->add_group_field( $support, array(
    'name' => esc_html__( 'Support List', 'themeplace' ),
    'id'   => 'support_list',
    'type' => 'text',
    'repeatable' => true
  ) );
  ...
  $item_faq = $download->add_field( array(
      ...
      'description' => esc_html__( 'Generates reusable form entries', 'themeplace' ),
      'options'     => array(
      'group_title'   => esc_html__( 'FAQs {#}', 'themeplace' ),
      'add_button'    => esc_html__( 'Add Another FAQ', 'themeplace' ),
      'remove_button' => esc_html__( 'Remove FAQ', 'themeplace' ),
      'sortable'      => true,
    ),
  ) );

  $download->add_group_field( $item_faq, array(
    'name' => esc_html__( 'FAQ Title', 'themeplace' ),
    'id'   => 'themeplace_faq_title',
    'type' => 'text',
  ) );

  $download->add_group_field( $item_faq, array(
    'name' => esc_html__( 'FAQ Description', 'themeplace' ),
...
function themeplace_add_user_social_links( $user_contact ) {
    ...
    $user_contact['twitter']   = esc_html__('Twitter Link', 'themeplace');
    $user_contact['facebook']  = esc_html__('Facebook Link', 'themeplace');
    $user_contact['linkedin']  = esc_html__('LinkedIn Link', 'themeplace');
    $user_contact['github']    = esc_html__('Github Link', 'themeplace');
    $user_contact['instagram'] = esc_html__('Instagram Link', 'themeplace');
    $user_contact['dribbble']  = esc_html__('Dribbble Link', 'themeplace');
    $user_contact['behance']   = esc_html__('Behance Link', 'themeplace');
    $user_contact['skype']     = esc_html__('Skype Link', 'themeplace');
...
function themeplace_comment_badges( $return, $author, $comment_ID ) {
  ...
  if ( $display_purchased_badge ) {
    $return .= '<span class="badge-purchased">'.esc_html( 'purchased','themeplace' ).'</span>';
  }
  ...
  if ( $display_author_badge ) {
    $return .= '<span class="badge-author">'.esc_html( 'author','themeplace' ).'</span>';
  }
...
function themeplace_login_link_to_menu ( $items, $args ) {
    ...
    if ( $args->theme_location == 'primary' ) {
      ...
      if ( true == $themeplace_navbar_login_signup ) {      
        ...
        $items .= '<li class="menu-item menu-login-url"><a href="#themeplace-login">'.__( 'Login', 'themeplace' ).'</a></li>';
        } else {
          $items .= '<li class="menu-item menu-logout-url"><a href="'.wp_logout_url(home_url()).'">'.__( 'Logout', 'themeplace' ).'</a></li>';
        }
      }
    }
...
function themeplace_login_member(){
    ...
    if( !check_ajax_referer( 'ajax-login-nonce', 'login-security', false) ){
      echo json_encode(array('error' => true, 'message'=> '<div class="alert alert-danger">'.__('Session token has expired, please reload the page and try again', 'themeplace').'</div>'));
    }
    
    // Check if input variables are empty
    elseif( empty($user_login) || empty($user_pass) ){
      echo json_encode(array('error' => true, 'message'=> '<div class="alert alert-danger">'.__('Please fill all form fields', 'themeplace').'</div>'));
      ...
      $user = wp_signon( array('user_login' => $user_login, 'user_password' => $user_pass), false );
        ...
        echo json_encode(array('error' => false, 'message'=> '<div class="alert alert-success">'.__('Login successful, reloading page...', 'themeplace').'</div>'));
      }
    }
...
function themeplace_register_member(){
    ...
    if( is_wp_error($errors) ){
      ...
      echo json_encode(array('error' => false, 'message' => '<div class="alert alert-success">'.__( 'Registration complete. Please check your e-mail.', 'themeplace').'</p>'));
    }
            ...
            <?php
              ...
              if( get_option('users_can_register') ){ ?>
                ...
                <div class="themeplace-register">
                  ...
                  <h4><?php printf( __('Join %s', 'themeplace'), get_bloginfo('name') ); ?></h4>
                  <hr>

                  <form id="themeplace_registration_form" action="<?php echo home_url( '/' ); ?>" method="POST">

                    <div class="form-field">
                      <label><?php _e('Username', 'themeplace'); ?></label>
                      <input class="form-control required" name="themeplace_user_login" type="text"/>
                    </div>
                    <div class="form-field">
                      <label for="themeplace_user_email"><?php _e('Email', 'themeplace'); ?></label>
                      <input class="form-control required" name="themeplace_user_email" id="themeplace_user_email" type="email"/>
                    </div>

                    <div class="form-field">
                      <input type="hidden" name="action" value="themeplace_register_member"/>
                      <button class="themeplace-btn" data-loading-text="<?php _e('Loading...', 'themeplace') ?>" type="submit"><?php _e('Sign up', 'themeplace'); ?></button>
                    </div>
                ...
                <div class="themeplace-login" data-redirect="<?php echo esc_url( $themeplace_navbar_login_redirect ) ?>">
                  ...
                  <h4><?php printf( __('Login to %s', 'themeplace'), get_bloginfo('name') ); ?></h4>
                  <hr>
                  ...
                  <form id="themeplace_login_form" action="<?php echo home_url( '/' ); ?>" method="post">
                    ...
                    <div class="form-field">
                      <label for="themeplace_user_pass"><?php _e('Password', 'themeplace')?></label>
                      <input class="form-control required" name="themeplace_user_pass" id="themeplace_user_pass" type="password"/>
                    </div>
                    <div class="form-field">
                      <input type="hidden" name="action" value="themeplace_login_member"/>
                      <button class="themeplace-btn" data-loading-text="<?php _e('Loading...', 'themeplace') ?>" type="submit"><?php _e('Login', 'themeplace'); ?></button> <a class="alignright" href="<?php echo wp_lostpassword_url(); ?>"><?php _e('Lost Password?', 'themeplace') ?></a>
                    </div>
                ...
                <div class="themeplace-loading">
                  <p><i class="fa fa-refresh fa-spin"></i><br><?php _e('Loading...', 'themeplace') ?></p>
                </div><?php

              } else {
                echo '<h4>'.__('Login access is disabled', 'themeplace').'</h4>';
              } ?>
          </div>
          <div class="modal-footer">
              <span class="themeplace-register-footer"><?php _e('Don\'t have an account?', 'themeplace'); ?> <a href="#themeplace-register"><?php _e('Sign Up', 'themeplace'); ?></a></span>
              <span class="themeplace-login-footer"><?php _e('Already have an account?', 'themeplace'); ?> <a href="#themeplace-login"><?php _e('Login', 'themeplace'); ?></a></span>
          </div>        
        </div>
      </div>
    </div>
