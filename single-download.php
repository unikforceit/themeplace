                ...
                <?php while ( have_posts() ) : the_post(); ?>
                    ...
                    <div class="single-download-thumbnail">
                        <?php if ( $type == 'video' ): ?>
                            ...
                            <a class="themeplace-button" href="<?php echo esc_url( $video ); ?>" download ><?php echo esc_html__( 'Download', 'themeplace' ); ?></a>
                    ...
                    <div class="mobile widget-themeplace-price">
                        ...
                        if ( $affiliate_url ) { ?>
                            <a class="affiliate_btn edd-submit" target="_blank" href="<?php echo esc_url( $affiliate_url ) ?>"><?php echo esc_html__( 'Purchase','themeplace' ); ?></a>
                        <?php } else {
                            echo apply_filters( 'edd_product_details_widget_purchase_button', edd_get_purchase_link( array( 'download_id' => get_the_ID() ) ) );
                        }
                        
                        if ( $preview_url ){ ?>
                            <a class="themeplace-button live-button" href="<?php echo esc_url( $preview_url ); ?>" target="_blank"><i class="fa fa-eye"></i><?php echo esc_html__( 'Live preview', 'themeplace' ); ?></a>
                        <?php }
                    ...
                    <div class="single-download-nav-mobile">
                        <ul class="single-download-nav nav" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" data-toggle="pill" href="#item-details"><?php echo esc_html__( 'Item Details', 'themeplace' ); ?></a>
                            </li>
                            <?php if ( comments_open() || get_comments_number() ): ?>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="pill" href="#item-comments"><?php echo esc_html__( 'Comments', 'themeplace' ); ?></a>
                            </li>
                            <?php endif ?>
                            <?php if ( class_exists( 'EDD_Reviews' ) ): ?>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="pill" href="#item-reviews"><?php echo esc_html__( 'Reviews', 'themeplace' ); ?></a>
                            </li>                            
                            <?php endif ?>
                            <?php if ( $support || class_exists( 'EDD_Front_End_Submissions' ) ) : ?>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="pill" href="#item-support"><?php echo esc_html__( 'Support', 'themeplace' ); ?></a>
                            </li>                 
                            <?php endif ?>
                            <?php if ( $item_faq ): ?>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="pill" href="#item-faq"><?php echo esc_html__( 'item FAQ', 'themeplace' ); ?></a>
                            </li>
                            <?php endif ?>
                        </ul>
                    </div>
